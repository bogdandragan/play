            ...
            success: function(data){
                ...
                if(obj['error'] == ''){
                    ...
                    if(isAdmin == false){
                        ...
                        $( "#photo" ).attr( "src", "http://localhost/test/service/"+photo);
                ...
                if(obj['error'] == ''){
                    ...
                    $.each(arr, function(index, value) {
                        ...
                        if(value.timestamp[length-1] == null)
                            visit = "new user";
                        var row = '<tr><td><img alt="pic" class="img-circle" height="50px" width="50px" src="'+"http://localhost/test/service/"+value.photo+'"></img></td><td>'+value.name+'</td><td>'+value.lastname+
                        '</td><td>'+value.email+'</td><td>'+value.address+'</td><td id="visit">'+visit+'</td><td class="text-center"><button id="usrEdit" class="btn btn-primary btn-sm" data-button="'+value._id.$oid+'" data-toggle="modal" data-target="#usrModal">'+
